...
namespace Host.Helpers
{
    public class HttpHelper
    {
        ...
        public async Task Update(string url, object request = null)
        {
            using (HttpClient client = new HttpClient())
            {
                ...
                if (request != null)
                {
                    ...
                    content = new StringContent(jsonContent, Encoding.UTF8, "application/json"); //JSON içeriği bir StringContent nesnesine ekliyoruz. HTTP isteği gönderilirken bu içerik gönderilebilir
                }
